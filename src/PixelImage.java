...
public class PixelImage
{
    ...
    /**
     * Sets the new rotated image values in the constructor
     *
     * @param h The rotated images new height
     * @param w The rotated images new width
     * @param buff BufferedImage version of rotated image
     */
    public void updateImage(int h, int w, BufferedImage buff){
        this.height = h;
        this.width = w;
        this.myImage = buff;
    }
